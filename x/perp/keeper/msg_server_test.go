...
func TestMsgServerAddMargin(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			t.Log("fund trader")
			require.NoError(t, testutil.FundAccount(app.BankKeeper, ctx, traderAddr, tc.traderFunds))
...
func TestMsgServerRemoveMargin(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			t.Log("fund vault")
			require.NoError(t, testutil.FundModuleAccount(app.BankKeeper, ctx, types.VaultModuleAccount, tc.vaultFunds))
...
func TestMsgServerClosePosition(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			require.NoError(t, testutil.FundModuleAccount(app.BankKeeper, ctx, types.VaultModuleAccount, sdk.NewCoins(sdk.NewInt64Coin(tc.pair.QuoteDenom(), 1))))
...
func TestMsgServerMultiLiquidate(t *testing.T) {
	...
	require.NoError(t, testutil.FundModuleAccount(app.BankKeeper, ctx, types.VaultModuleAccount, sdk.NewCoins(sdk.NewInt64Coin(pair.QuoteDenom(), 2))))
...
func TestMsgServerDonateToEcosystemFund(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			app, ctx := testapp.NewNibiruTestAppAndContext(true)
			msgServer := keeper.NewMsgServerImpl(app.PerpKeeper)
			require.NoError(t, testutil.FundAccount(app.BankKeeper, ctx, tc.sender, tc.initialFunds))
